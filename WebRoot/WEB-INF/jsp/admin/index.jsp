...
<!-- #1c77ac -->
<body style="background-color:000000; background-image:url(images/light.png); background-repeat:no-repeat; background-position:center top; overflow:hidden;">
...
<div class="logintop">    
    ...
    <ul>
    <form method="post" action="${pageContext.request.contextPath }/admin/adminUser_login.action" target="_parent" name='theForm' onsubmit="return validate();">
