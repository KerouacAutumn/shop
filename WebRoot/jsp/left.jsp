...
<table width="100%" border="0" >
	  <tr>
		...
		<script type="text/javascript">
			...
			d.add('010502','0105','已下单订单','${pageContext.request.contextPath}/admin/adminOrder_findByState.action?page=1&state=0','','mainFrame');
			d.add('010503','0105','待配送订单','${pageContext.request.contextPath}/admin/adminOrder_findByState.action?page=1&state=1','','mainFrame');
			d.add('010504','0105','已发货订单','${pageContext.request.contextPath}/admin/adminOrder_findByState.action?page=1&state=2','','mainFrame');
			d.add('010505','0105','待收款订单','${pageContext.request.contextPath}/admin/adminOrder_findByState.action?page=1&state=3','','mainFrame');
