						...
						<tr>
							...
							订单金额:<font color="red">${order.money}</font>&nbsp;&nbsp;&nbsp;&nbsp;
								订单状态： <c:if test="${order.state==0}">
									<a style="color: red;"
										href="${pageContext.request.contextPath}/payOrderAganin.action?oid=${order.oid}">待购买</a>
									</c:if> 
									...
									<a style="color: red;"
										href="${pageContext.request.contextPath}/updateState.action?oid=${order.oid}">已收到货并付款</a>
									</c:if> 
