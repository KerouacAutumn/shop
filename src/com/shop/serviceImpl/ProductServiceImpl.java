...
//		商品集合
	...
	@Override
	public void updateStock(Integer pid, Integer stock) {
		productMapper.updateStock(pid, stock);
		
	}
	@Override
	public void deleteProductBycsid(int csid) {
		productMapper.deleteBycsid(csid);
